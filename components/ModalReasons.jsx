    ...
    return (
        <>
            <S.Modal $display={display}>
                ...
                <p>Aidez-moi à acheter un MacBook, sinon je vais être obligé de continuer à utiliser mon vieux PC qui est plus lent que ma grand-mère.</p>
                ...
                <p>Je veux un MacBook parce que je veux travailler avec style - et avouez-le, tout le monde a besoin d'un peu plus de style dans sa vie !</p>
